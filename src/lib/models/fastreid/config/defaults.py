...
_C.MODEL.HEADS.NECK_FEAT = "after"  # options: before, after
# Pooling layer type
_C.MODEL.HEADS.POOL_LAYER = "clipavgpool"

# Classification layer type
_C.MODEL.HEADS.CLS_LAYER = "circleSoftmax"  # "arcSoftmax" or "circleSoftmax"

# Margin and Scale for margin-based classification layer
_C.MODEL.HEADS.MARGIN = 0.35
_C.MODEL.HEADS.SCALE = 64
...
# Low frequency
_C.INPUT.LOWF = CN()
_C.INPUT.LOWF.ENABLED = True
_C.INPUT.LOWF.PROB = 0.5
