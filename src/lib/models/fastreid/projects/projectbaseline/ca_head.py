...
from projects.centerTrack.fastreid.layers import *
from projects.centerTrack.fastreid.modeling.heads import EmbeddingHead
from projects.centerTrack.fastreid.modeling.heads.build import REID_HEADS_REGISTRY
from projects.centerTrack.fastreid.utils.weight_init import weights_init_kaiming, weights_init_classifier
...
class CamAwareHead(EmbeddingHead):
    def __init__(self, cfg):
        ...
        self.cam_bottleneck = nn.Sequential(
            ...
            get_norm(cfg.MODEL.HEADS.NORM, cam_feat, bias_freeze=True),
            nn.LeakyReLU(0.1),
            nn.Dropout2d(p=0.5),
        )
