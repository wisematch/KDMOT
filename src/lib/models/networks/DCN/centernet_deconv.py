...
class Fake_DCN(nn.Module):
    '''
    ModulatedDeformConvWithOff with names changed.
        offset_mask_conv -> conv_offset_mask
        dcnv2 -> dcnv2, removed at loading
    '''
    def __init__(
        self,
        in_channels,
...
class CenternetDeconv(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.directly_output = True if 'dla' in cfg.MODEL.BACKBONE.NAME else False
