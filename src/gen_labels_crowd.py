...
if __name__ == '__main__':
    data_val = '/export/wei.zhang/datasets/mixdata/crowdhuman/images/val'
    label_val = '/export/wei.zhang/datasets/mixdata/crowdhuman/labels_with_ids/val'
    ann_val = '/export/wei.zhang/datasets/mixdata/crowdhuman/annotation_val.odgt'
    data_train = '/export/wei.zhang/datasets/mixdata/crowdhuman/images/train'
    label_train = '/export/wei.zhang/datasets/mixdata/crowdhuman/labels_with_ids/train'
    ann_train = '/export/wei.zhang/datasets/mixdata/crowdhuman/annotation_train.odgt'
